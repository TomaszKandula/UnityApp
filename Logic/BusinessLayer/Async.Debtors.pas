        ...
        try
            ...
            begin
                ...
                try
                    ...
                    Grid.Cells[15,0]:=ReturnCustSnapshots._PaymentTerms;
                    Grid.Cells[16,0]:='Risk Class'; // Autogenerated, setup only header
                    Grid.Cells[17,0]:=ReturnCustSnapshots._LedgerIso;
                    Grid.Cells[18,0]:=ReturnCustSnapshots._SourceDbName;
                    Grid.Cells[19,0]:=ReturnCustSnapshots._Free1;
                    Grid.Cells[20,0]:=ReturnCustSnapshots._Free2;
                    Grid.Cells[21,0]:=ReturnCustSnapshots._Free3;
                    Grid.Cells[22,0]:=ReturnCustSnapshots._SalesResponsible;
                    Grid.Cells[23,0]:=ReturnCustSnapshots._PersonResponsible;
                    ...
                    begin
                        ...
                        Grid.Cells[15,iCNT]:=ReturnCustSnapshots.PaymentTerms[iCNT - 1].ToString();
                        Grid.Cells[17,iCNT]:=ReturnCustSnapshots.LedgerIso[iCNT - 1];
                        Grid.Cells[18,iCNT]:=ReturnCustSnapshots.SourceDbName[iCNT - 1];
                        Grid.Cells[19,iCNT]:=ReturnCustSnapshots.Free1[iCNT - 1];
                        Grid.Cells[20,iCNT]:=ReturnCustSnapshots.Free2[iCNT - 1];
                        Grid.Cells[21,iCNT]:=ReturnCustSnapshots.Free3[iCNT - 1];
                        Grid.Cells[22,iCNT]:=ReturnCustSnapshots.SalesResponsible[iCNT - 1];
                        Grid.Cells[23,iCNT]:=ReturnCustSnapshots.PersonResponsible[iCNT - 1];
