        ...
        try
            ...
            begin
                ...
                try
                    ...
                    Grid.Cells[13,0]:=ReturnCustSnapshots._CreditLimit;
                    Grid.Cells[14,0]:=ReturnCustSnapshots._CreditBalance;
                    Grid.Cells[15,0]:=ReturnCustSnapshots._LedgerIso;
                    Grid.Cells[17,0]:=ReturnCustSnapshots._SourceDbName;
                    Grid.Cells[18,0]:=ReturnCustSnapshots._Free1;
                    Grid.Cells[19,0]:=ReturnCustSnapshots._Free2;
                    Grid.Cells[20,0]:=ReturnCustSnapshots._Free3;
                    Grid.Cells[21,0]:=ReturnCustSnapshots._SalesResponsible;
                    Grid.Cells[22,0]:=ReturnCustSnapshots._PersonResponsible;
                    Grid.Cells[23,0]:=ReturnCustSnapshots._CustomerGroup;
                    Grid.Cells[24,0]:=ReturnCustSnapshots._AccountType;
                    Grid.Cells[25,0]:=ReturnCustSnapshots._Inf4;
                    Grid.Cells[26,0]:=ReturnCustSnapshots._Group3;
                    Grid.Cells[16,0]:='Risk Class'; // Autogenerated, setup only header
                    ...
                    begin
                        ...
                        Grid.Cells[13,iCNT]:=ReturnCustSnapshots.CreditLimit[iCNT - 1].ToString();
                        Grid.Cells[14,iCNT]:=ReturnCustSnapshots.CreditBalance[iCNT - 1].ToString();
                        Grid.Cells[15,iCNT]:=ReturnCustSnapshots.LedgerIso[iCNT - 1];
                        Grid.Cells[17,iCNT]:=ReturnCustSnapshots.SourceDbName[iCNT - 1];
                        Grid.Cells[18,iCNT]:=ReturnCustSnapshots.Free1[iCNT - 1];
                        Grid.Cells[19,iCNT]:=ReturnCustSnapshots.Free2[iCNT - 1];
                        Grid.Cells[20,iCNT]:=ReturnCustSnapshots.Free3[iCNT - 1];
                        Grid.Cells[21,iCNT]:=ReturnCustSnapshots.SalesResponsible[iCNT - 1];
                        Grid.Cells[22,iCNT]:=ReturnCustSnapshots.PersonResponsible[iCNT - 1];
                        Grid.Cells[23,iCNT]:=ReturnCustSnapshots.CustomerGroup[iCNT - 1];
                        Grid.Cells[24,iCNT]:=ReturnCustSnapshots.AccountType[iCNT - 1];
                        Grid.Cells[25,iCNT]:=ReturnCustSnapshots.Inf4[iCNT - 1];
                        Grid.Cells[26,iCNT]:=ReturnCustSnapshots.Group3[iCNT - 1];
                    end;

                    PayLoad.AgeDate:=ReturnCustSnapshots._AgeDate;
