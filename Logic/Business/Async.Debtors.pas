        ...
        try
            ...
            begin
                ...
                try
                    ...
                    if not FileExists(Service.Settings.DirLayouts + TCommon.GridLayout) then
                    begin
                        Grid.Cells[0, 0]:='';
                    ...
                    begin
                        ...
                        try
                            ...
                            Service.Mediator.Utility.LoadAgeLayoutSync(Service.Settings.DirLayouts + TCommon.GridLayout, LLayoutColumns);
