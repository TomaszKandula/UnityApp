...
type
	...
	strict private
        ...
        var FOpenCurAm:         TArray<double>;
        var FOpenAm:            TArray<double>;
        var FCustName:          TArray<string>;
        var FIso:               TArray<string>;
        var FCurAm:             TArray<double>;
        var FAm:                TArray<double>;
	...
	public
        ...
        const _CustNumber        = 'CustNumber';
        const _VoucherType       = 'VoucherType';
        const _OpenCurAm         = 'OpenCurAm';
        const _OpenAm            = 'OpenAm';
        const _CustName          = 'CustName';
        const _Iso               = 'Iso';
        const _CurAm             = 'CurAm';
        const _Am                = 'Am';
        ...
        const _PmtTerms          = 'PmtTerms';
        const _PmtStatus         = 'PmtStatus';
        const _Agent             = 'Agent';
    ...
    published
        ...
        property OpenCurAm:         TArray<double>  read FOpenCurAm         write FOpenCurAm;
        property OpenAm:            TArray<double>  read FOpenAm            write FOpenAm;
        property CustName:          TArray<string>  read FCustName          write FCustName;
        property Iso:               TArray<string>  read FIso               write FIso;
        property CurAm:             TArray<double>  read FCurAm             write FCurAm;
        property Am:                TArray<double>  read FAm                write FAm;
