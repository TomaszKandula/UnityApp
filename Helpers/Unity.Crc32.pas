...
begin
    ...
    begin
        ...
        repeat
            ...
            for var iCNT: integer:= 1 to BytesRead do
                Result:=(Result shr 8) xor Table[Buffer[iCNT] xor (Result and $000000FF)];
...
begin
    ...
    {$I-}
    for var iCNT: integer:=1 to Length(Str) do
        result:=(result shr 8) xor table[ Byte( Str[iCNT] ) xor (result and $000000FF) ];
    {$I+}
