...
procedure TForm1.WndProc(var Msg: Messages.TMessage);
begin
  inherited;

  if Msg.Msg = WM_MOVE          then if (ChromiumWindow1 <> nil) then ChromiumWindow1.NotifyMoveOrResizeStarted;
  if Msg.Msg = WM_MOVING        then if (ChromiumWindow1 <> nil) then ChromiumWindow1.NotifyMoveOrResizeStarted;
